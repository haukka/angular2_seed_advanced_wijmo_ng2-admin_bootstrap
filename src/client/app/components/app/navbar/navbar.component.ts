...
export class NavbarComponent implements AfterViewInit, OnInit {
  ...
  constructor(private _elementRef:ElementRef,
    ...
    this._state.subscribe('menu.isCollapsed', (isCollapsed:any) => { this.isMenuCollapsed = isCollapsed; });
  }
  ...
  public toggleSubMenu($event:any, item:any):boolean {
  ...
  private _selectMenuItem(currentPath:any = null):void {
